...
hipótesis, $\pi_2(K)$ es cerrado en $Y$ y $X\subseteq\pi_2(K)$ ya que $X\times X\subseteq\Delta$.
$\infty\in \pi_2(K)$, debido a la propiedad de intersecciones finitas, ya que esta
implica que $\{\infty\}$ no es abierto en $Y$, luego toda vecindad de $\infty$.
Debido a esto, existe $x\in X$ tal que $(x,\infty)\in K$. Esto es, para todo
